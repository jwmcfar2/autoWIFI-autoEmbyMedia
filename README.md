...
Usage Summary: 
 - Plugging in a USB storage drive will initiate my scripts (negligible performance impact, **_but_** if successful it leaves the drive mounted to specified folder)
